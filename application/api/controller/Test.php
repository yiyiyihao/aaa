...
class Test
{
    ...
    public function app()
    {
        ...
        $url = 'http://'.'project.cc'.'/api/app/index';
...
//                    'title'           => $todoData['title'],
        ...
        $result = $push->sendToUid('uid1', json_encode($sendData));
        pre($result);
        /*$param = [
            'name' => 'XXXX',
            'level' => 'vip'
...
//        $token = 'h14jIiNeakgtqJTeQeiUDDWepcfRrKts1Q2uTCY2iJFHXqptQpAhRFeSgxjkyjUo';
        ...
        /************************************************/
        $username = '15777026332';
        $phone = '15777026332';
        $password = md5('m123456');
        $repassword = md5('m123456');
    ...
    public function zhongtai()
    {
        ...
        $data = db('user')->where([['is_admin','IN',[1,2]],['is_del','=',0],['user_id','<>',1]])->select();
        foreach($data as $k => $v){
