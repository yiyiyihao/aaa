...
class zhongtai
{
     ...
     * 注册为管理员用户
     */
    public function register($username,$phone,$password,$repassword,$token,$source='shop')
    {
     ...
     * 修改门店商品库存
     */
    public function change_shop_stock($params,$token)
    {
        $url = $this->uri . '/v1/item/index/changeshopstock';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 订单发货
     */
    public function order_delivery($params,$token)
    {
        $url = $this->uri . '/v1/transaction/order/delivery';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 订单地址设置——客户订单
     */
    public function order_address($params,$token)
    {
        $url = $this->uri . '/v1/transaction/order/address';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 添加订单操作日志
     */
    public function order_createlog($params,$token)
    {
        $url = $this->uri . '/v1/transaction/order/createlog';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 地址列表
     */
    public function address_list($params,$token)
    {
        $url = $this->uri . '/v1/user/address/list';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 获取地址详情
     */
    public function address_get($params,$token)
    {
        $url = $this->uri . '/v1/user/address/get';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 新增地址
     */
    public function address_create($params,$token)
    {
        $url = $this->uri . '/v1/user/address/create';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 编辑地址
     */
    public function address_update($params,$token)
    {
        $url = $this->uri . '/v1/user/address/update';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 删除地址
     */
    public function address_del($params,$token)
    {
        $url = $this->uri . '/v1/user/address/del';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 获取默认收货地址
     */
    public function snget($params,$token)
    {
        $url = $this->uri . '/v1/item/index/snget';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
     ...
     * 获取默认收货地址
     */
    public function address_default($params,$token)
    {
        $url = $this->uri . '/v1/user/address/default';
        $headers = ['Authorization:'.$token];
        $result = curl_request($url, $params, $headers);
        return $result;
    }
