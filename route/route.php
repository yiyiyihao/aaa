...
Route::post(':version/order/order_pay','api/:version.order.order1/order_pay');
Route::post(':version/order/order_delivery','api/:version.order.order1/order_delivery');
Route::post(':version/order/order_address','api/:version.order.order1/order_address');
Route::post(':version/order/createlog','api/:version.order.order1/createlog');
Route::post(':version/order/create_order','api/:version.order.order1/createOrder');
Route::post(':version/order/cance_order','api/:version.order.order1/cancel');
Route::post(':version/order/finish_order','api/:version.order.order1/finish');
//test
Route::post(':version/order/order2_list','api/:version.order.order2/orderlist');
Route::post(':version/order/order2_info','api/:version.order.order2/orderinfo');
Route::post(':version/order/order2_delivery','api/:version.order.order2/order_delivery');
Route::post(':version/order/order2_create','api/:version.order.order2/createOrder');
Route::post(':version/order/order2_cancel','api/:version.order.order2/cancel');
